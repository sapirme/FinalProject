...
public class SVGParserTest {
    ...
    public void illusionFromSVGTest() {
        ...
        Assert.assertTrue(SVGParser.decide(SVG1_Yes,null,null));
        ...
        Assert.assertTrue(SVGParser.decide(SVG2_Yes,null,null));
        ...
        Assert.assertTrue(SVGParser.decide(SVG3_Yes,null,null));
        ...
        Assert.assertTrue(SVGParser.decide(SVG4_Yes,null,null));
        ...
        Assert.assertTrue(SVGParser.decide(SVG5_Yes,null,null));
    }
    @Test
    public void notIllusionFromSVGTest() {
        ...
        Assert.assertFalse(SVGParser.decide(SVG1_No,null,null));
        ...
        Assert.assertFalse(SVGParser.decide(SVG2_No,null,null));
    }
