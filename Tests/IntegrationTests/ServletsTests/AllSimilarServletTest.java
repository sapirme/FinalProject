...
public class AllSimilarServletTest {
    ...
    public int sendReq(){
        int status = -1;
        try {
            URL url = new URL(myUrl+"/allSimilar");
    ...
    @Test
    public void testGetAllSimilarReqDbNotConnected() {
        String[] args = {"8090", "", "0"};
    ...
    @Test
    public void testGetAllSimilarReqWithDb() {
        String[] args = {};
        server = new IllusionServer();
        try{
            server.init(args);
    ...
    @Test
    public void testGetAllSimilarIllegalInput() {
        String[] args = {};
        server = new IllusionServer();
        try{
            server.init(args);
